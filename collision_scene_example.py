...
class CollisionSceneExample(object):
    ...
    def add_table(self, pose = None, dims = None, name = "table"):

        if (pose or dims) is None: 
            box1_pose = [0, 0, -0.1, 0, 0, 0, 1]
            box1_dimensions = [1.2, 1.2, 0.0001]
            # box1_pose = [0.25, 0.25, 0.0, 0, 0, 0, 1]
            # box1_dimensions = [0.25, 0.25, 0.75]
        else:
            box1_pose = pose
            box1_dimensions = dims
        self.add_box_object(name, box1_dimensions, box1_pose)
